...
public class SnowflakeDataStoreFactory extends JDBCDataStoreFactory {
    ...
    public static final Param DBTYPE = new Param("dbtype", String.class, "Database type", true, "snowflake");
    public static final Param HOST = new Param("account", String.class, "Snowflake account", true);
    ...
    private JDBCDataStore createSnowflakeDataStore(JDBCDataStore dataStore, Map<String, Object> params) throws IOException {
        try {
