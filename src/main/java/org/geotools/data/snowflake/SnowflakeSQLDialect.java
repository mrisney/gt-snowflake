...
public class SnowflakeSQLDialect extends SQLDialect {
	...
	@Override
	public void encodeGeometryColumn(GeometryDescriptor descriptor, String prefix, int srid, Hints hints,
			StringBuffer sql) {
	...
	public Geometry decodeGeometryValue(GeometryDescriptor descriptor, ResultSet rs, String column,
			GeometryFactory factory, Connection cx, Hints hints) throws SQLException {
	...
	public void encodeGeometryEnvelope(String tableName, String geometryColumn, StringBuffer sql) {
		...
		sql.append("SELECT ST_AsText(ST_Envelope(").append(geometryColumn).append(")) AS envelope FROM ")
				.append(tableName);
	}
}
